...
<body>
  ...
  <main id="main">
    ...
    <div class="containerss">
      <div class="center">  
        <form>
        <input type="button" class= "btn btn-info" value="Tambah Tahun" onclick="window.location.href='../admin/tambahtahun.php'" />
        </form><br/>
      </div>
    </div>
      ...
      $result = $conn-> query($query);
        if ($result->num_rows > 0){
          ...
          echo "<td><a href='isitahun.php?idtahun=".$row['idtahun']."'>Edit</a></td>";
          echo "<td><a href='../php/deletetahun.php?idtahun=".$row['idtahun']."'>Delete</a></td>";
          echo "</tr>";
          }
          echo "</tbody>";
          echo "</table>";
