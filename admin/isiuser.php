  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Ubah Data Penyewa</h2>
          <ol>
            <li><a href="../indexadmin.php">Home</a></li>
            <li>Ubah Data Penyewa</li>
          </ol>
        </div>
    ...
    <!-- ======= Isi User ======= -->
      ...
      <?php
        ...
        $query="SELECT * FROM user WHERE no_karyawan='$noKar'";
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="isiuser">
        <div class="my-auto">      
           ...
           <form action="../php/updateuser.php?no_karyawan=<?php echo($noKar)?>" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" style="text-align:center;" name="nama" class="form-control" autofocus="on" value="<?php echo $Nama; ?>" placeholder="maksimal 50 karakter"> 
          </div>
          <div class="form-group">
