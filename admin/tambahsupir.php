    ...
    <!-- ======= Isi User ======= -->
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="isiuser">
        <div class="my-auto">      
           ...
           <form action="../php/daftarsupir.php" method="POST">
          <div class="form-group">
            <label for="nama">Nama</label>
            <input type="text" style="text-align:center;" name="nama" class="form-control" placeholder="maksimal 21 karakter" required> 
          </div>
          <div class="form-group">
