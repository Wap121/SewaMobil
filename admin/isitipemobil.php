...
<head>
  ...
  <title>Edit Data Jenis Mobil</title>
...
<body>
  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Edit Tipe Mobil</h2>
          <ol>
            <li><a href="../indexadmin.php">Home</a></li>
            <li>Edit Tipe Mobil</li>
          </ol>
        </div>
    ...
    <!-- ======= Isi Tipe Mobil ======= -->
      ...
      <?php
        $noTip = $_GET['idtype'];
        $query="SELECT * FROM tipe_mobil WHERE idtype='$noTip'";
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="isiuser">
        <div class="my-auto">      
           ...
           <form action="../php/updatetipemobil.php?idtype=<?php echo($noTip)?>" method="POST">
          <div class="form-group">
            <label for="tipe">Tipe</label>
            <input type="text" style="text-align:center;" name="tipe" class="form-control" value="<?php echo $Tipe; ?>">
          </div>
