...
<body>
  ...
  <main id="main">
    ...
    <div class="containerss">
      <div class="center">  
        <form>
        <input type="button" class= "btn btn-info " value="Simpan Data ke Excel" onclick="window.location.href='../php/printexcelsupir.php'" />
        </form><br/> 
      </div>
    </div>
    <div class="containerss">
      <div class="center">  
        <form>
        <input type="button" class= "btn btn-info" value="Tambah Supir" onclick="window.location.href='tambahsupir.php'" />
        </form><br/>
      </div>
    </div>
      ...
      $result = $conn-> query($query);
        if ($result->num_rows > 0){
          ...
          echo "<td><a href='isisupir.php?no_supir=".$row['no_supir']."'>Edit</a></td>";
          echo "<td><a href='../php/deletesupir.php?no_supir=".$row['no_supir']."'>Delete</a></td>";
          echo "</tr>";
          }
          echo "</tbody>";
          echo "</table>";
