...
<body>
  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Edit Kontak Admin</h2>
          <ol>
            <li><a href="../indexadmin.php">Home</a></li>
            <li>Edit Kontak Admin</li>
          </ol>
        </div>
    ...
    <!-- ======= Isi User ======= -->
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="isisupir">
        <div class="my-auto">      
            <div class="container">
               <div class="row">
          ...
          <div class="form-group">
            <label for="telepom">No WhatsApp yang dapat dihubungi</label>
            <input type="text" style="text-align:center;" name="telepon" class="form-control" autofocus="on" value="<?php echo $Telp; ?>"> 
          </div>
          <div class="form-group">
            <label for="Email">Email</label>
            <input type="email" style="text-align:center;" name="Email" class="form-control" placeholder="name@example.com" value="<?php echo $Email; ?>">
          </div>
          <div class="form-group">
            <label for="lainnya">Kontak lainnya yang dapat dihubungi</label>
            <input type="text" style="text-align:center;" name="lainnya" class="form-control" value="<?php echo $Lainnya; ?>" >
          </div>
