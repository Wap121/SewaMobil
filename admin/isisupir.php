...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Isi User ======= -->
      ...
      <?php
        $noSupir = $_GET['no_supir'];
        $query="SELECT * FROM supir WHERE no_supir='$noSupir'";
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="isisupir">
        <div class="my-auto">      
           ...
           <form action="../php/updatesupir.php?no_supir=<?php echo($noSupir)?>" method="POST">
          <div class="form-group">
            <label for="nama">Nama</label>
            <input type="text" style="text-align:center;" name="nama" class="form-control" autofocus="on" value="<?php echo $Nama; ?>" placeholder="maksimal 21 karakter"> 
          </div>
          <div class="form-group">
