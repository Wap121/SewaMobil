...
<head>
  ...
  <title>Tambah Jenis Mobil</title>
    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="kontakadmin">Kontak Admin</a></li>
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Tambah Jenis Mobil</h2>
          <ol>
            <li><a href="../indexadmin.php">Home</a></li>
            <li>Tambah Jenis Mobil</li>
          </ol>
        </div>
    ...
    <!-- ======= Isi User ======= -->
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="isiuser">
        <div class="my-auto">      
           ...
           <form action="../php/daftarjenismobil.php" method="POST">
          <div class="form-group">
            <label for="tipe">Tipe</label>
            <input type="text" style="text-align:center;" name="tipe" class="form-control"  autofocus="on" required>
          </div>
